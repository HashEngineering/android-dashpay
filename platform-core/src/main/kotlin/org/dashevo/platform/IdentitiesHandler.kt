...
class IdentitiesHandler(val platform: Platform) {

  /*  fun register(platform: Platform, identityType: String = 'USER', burnAmount: Coin = Coin.valueOf(10000)): Identity {
        const { account, client } = platform;


        if (!Identity.IdentityType[identityType.toUpperCase()]) {
